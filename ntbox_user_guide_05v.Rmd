...
![Graphical User Interface of `ntbox`](figures/ntbox.png)
...
![](figures/ntbox_01_appsettings_01.png)
![](figures/ntbox_01_appsettings_01b.png)
...
![Aviable Global Climate Models](figures/ntbox_01_appsettings_03.png)
...
![GBIF search example](figures/ntbx_02_gbif.png)
...
![](figures/10_tutorial.png)

From **154** records only **2** are in Canada. 

![](figures/12_tutorial.png)
...
![](figures/ntbox_02_gbifvis.png)
![](figures/ambystoma_tigrinum_animatedMapNTB.gif)
...
![](figures/ntbox_02_dynamicpol_01.png)
...
![](figures/ntbox_02_dynamicpol_02.png)
...
![](figures/ntbox_02_dynamicpol_03.png)
...
![](figures/ntbox_07_proc.png) 

![](figures/ntbox_07_proc2.png)
...
![](figures/ntbox_07_binmethods.png)
...
![](figures/59_tutorial.png)

The output looks like this:

![](figures/ntbox_07_confmat.png)
![](figures/ntbox_07_confmat_bin.png)
![](figures/ntbox_07_confumat_res.png)
...
![](figures/ntbox_07_userth.png)

The result is:

![](figures/ntbox_07_userthR.png)

#### User defined threshold

Upload the continuous map and the presence data; then select the percentile that you want to work with (11 in this example).

![](figures/ntbox_07_percentil_selec.png)

The output is:

![](figures/ntbox_07_percentil_res.png)
...
![](figures/ntbox_07_binomial.png)

![](figures/ntbox_07_binomialRes.png)
...
![](figures/ntbox_08_mop3.png)

Press Run.

![](figures/ntbox_08_mop4.png)
...
![](figures/ntbox_08_mess1.png)

The result is:

![](figures/ntbox_08_mess.png)
...
![](figures/ntbox_08_exdet1.png)

Press run and the result looks like this:

![](figures/ntbox_08_exdet2.png)

### NT2

Follow the above steps and you will see:

![](figures/ntbox_08_exdet3.png)
...
![](figures/ntbox_09_export2.png)

Give a name to the folder where they will be exported and press go.

![](figures/ntbox_09_export3.png)

The output is:

![](figures/ntbox_09_export4.png)
...
![](figures/ntbox_10_workflow_sv.png)
...
![ntbox_10_gdata.html](figures/ntbox_10_gdata.png)
![ntbox_10_env_data.html](figures/ntbox_10_env_data.png)
![ntbox_10_enm.html](figures/ntbox_10_enm.png)
![ntbox_10_enm_eval.png](figures/ntbox_10_enm_eval.png)
